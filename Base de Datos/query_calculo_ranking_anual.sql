...
DELIMITER // 
CREATE TRIGGER CALCULAR_PUNTAJE_RANKING_ANUAL_AI_TRIGGER 
...
CREATE TRIGGER CALCULAR_PUNTAJE_RANKING_ANUAL_AU_TRIGGER 
...
CREATE TRIGGER CALCULAR_PUNTAJE_RANKING_ANUAL_BD_TRIGGER 
